...
BOARD_HARDWARE_CLASS += device/oukitel/K6000Pro/cmhw
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board K6000_PRO_V0
...
# Assert
TARGET_OTA_ASSERT_DEVICE := K6000Pro,OUKITEL
...
# RIL
BOARD_RIL_CLASS := ../../../device/oukitel/K6000Pro/ril
